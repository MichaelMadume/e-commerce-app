    ...
    combineLatest([
      ...
      .subscribe(([map, config]: [any, any]) => {
        ...
        this.mapData = [
          ...
          { 'code': 'CN', 'name': 'China', 'value': 13465324, 'color': this.getRandomGeoColor() },
          ...
          { 'code': 'IN', 'name': 'India', 'value': 12414960, 'color': this.getRandomGeoColor() },
          ...
          { 'code': 'NG', 'name': 'Nigeria', 'value': 1624070737, 'color': colors.success },
        ...
        this.options = {
          title: {
            text: `Global Sales ${moment().format('YYYY')}`,
            left: 'center',
            top: '16px',
            textStyle: {
          ...
          geo: {
            name: `Global Sales ${moment().format('YYYY')}`,
            type: 'map',
            map: 'world',
            roam: true,
            label: {
